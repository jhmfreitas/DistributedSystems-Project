...
public class RestaurantEndpointManager {
	...
	/** Port implementation */
	private RestaurantPortImpl portImpl = new RestaurantPortImpl(this);

	/** Obtain Port implementation */
	public RestaurantPortType getPort() {
		return portImpl;
	}
	...
	public RestaurantEndpointManager(String uddiURL, String wsName, String wsURL) {
	...
	public RestaurantEndpointManager(String wsURL) {
		if (wsURL == null)
