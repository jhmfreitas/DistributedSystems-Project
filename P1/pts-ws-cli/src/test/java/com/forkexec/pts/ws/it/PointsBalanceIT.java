...
public class PointsBalanceIT extends BaseIT{
    ...
    public void success() throws InvalidEmailFault_Exception, EmailAlreadyExistsFault_Exception {
        ...
        Assert.assertEquals(client.pointsBalance("goodEmail@goodEmail"), 100);
    }

    @Test(expected = InvalidEmailFault_Exception.class)
    public void InvalidEmailTest() throws InvalidEmailFault_Exception {
        client.pointsBalance("nonExistingEmail@nonExistingEmail");
    }
