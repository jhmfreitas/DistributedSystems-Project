...
public class SearchDealIT extends BaseIT {
	...
	@Test(expected = InvalidTextFault_Exception.class)
	public void searchDealWhitespaceTest() throws InvalidTextFault_Exception {
		client.searchDeal("   ");
	}
	
	@Test
	public void searchDealSuccessTest() throws InvalidTextFault_Exception, InvalidFoodIdFault_Exception{
		...
		assertEquals(1, client.searchDeal("Pudding").size());
		assertEquals(food.getId().getRestaurantId(), client.searchDeal("Pudding").get(0).getId().getRestaurantId());
		assertEquals(food.getId().getMenuId(), client.searchDeal("Pudding").get(0).getId().getMenuId());
		assertEquals(food.getDessert(), client.searchDeal("Pudding").get(0).getDessert());
	}
	
	
	@Test
	public void searchDealSuccessThreeResultsTest() throws InvalidTextFault_Exception, InvalidFoodIdFault_Exception{
		List<Food> expectedResult = new ArrayList<Food>();
		...
		List<Food> list = client.searchDeal("Chicken");
	...
	@Test
	public void searchDealFailureTest() throws InvalidTextFault_Exception, InvalidFoodIdFault_Exception{
		assertEquals(0,client.searchDeal("Potatoes").size());
